...
export default function OnboardingPage() {
    ...
    // Save Data Logic (moved from StepInterests to separate function called before Payment)
    ...
    const StepChildren = () => {
        ...
        const addChild = () => {
            setChildren([...children, { firstName: '', birthDate: '', gender: 'boy' }]);
        };
            ...
            <div className="animate-in fade-in slide-in-from-right duration-500">
                ...
                <div className="max-w-2xl mx-auto space-y-6">
                    ...
                    <div className="flex justify-end pt-6">
                        <button
                            onClick={() => setStep(3)}
                            disabled={children.some(c => !c.firstName || !c.birthDate)}

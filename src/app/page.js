...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-orange-50/30 overflow-x-hidden bg-noise">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium">
                Créez, personnalisez et lisez des histoires sur-mesure où son <span className="font-bold">prénom</span> et son <span className="font-bold">visage</span> prennent vie. Fini les héros qui ne lui ressemblent pas. Offrez-lui le plus beau cadeau pour sa <span className="font-bold text-orange-600 bg-orange-100 px-1 rounded">confiance en lui.</span>
              </p>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4 animate-fadeIn delay-150 mb-10">
                <div className="flex -space-x-4">
                  <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-200 overflow-hidden">
                    <Image src="https://i.pravatar.cc/100?img=5" alt="Parent" width={40} height={40} />
                  </div>
                  <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-200 overflow-hidden">
                    <Image src="https://i.pravatar.cc/100?img=9" alt="Parent" width={40} height={40} />
                  </div>
              ...
              >
                <Link href={`/book/${book.id}`}>
                  <div className="relative aspect-[3/4] mb-4 rounded-2xl overflow-hidden shadow-md group-hover:shadow-2xl transition-all duration-300">
                    ...
                    />
                    {/* Removed Button Overlay as requested */}
                  </div>
                  <h3 className="font-bold text-gray-900 group-hover:text-orange-600 transition-colors text-lg leading-tight">{book.title}</h3>
                  <p className="text-sm text-gray-500 mt-1">{book.ageRange}</p>
                </Link>
              </motion.div>
            ))}
          </div>
